 ...
 */
public class TFEScoreBoardActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.twentyFortyEightdifficulties, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        difficultySetting.setAdapter(adapter);

        title.setText("2048 Highscores");
        updateDisplay(3);
    ...
    private void updateDisplay(int difficulty) {
        ...
        List<ScoreItem> userScore = scoreBoard.getScorePerGames(TFEGame.GAME_NAME, difficulty);
        List<ScoreItem> gameScore = scoreBoard.getScorePerUser(TFEGame.GAME_NAME, user.getUserName(), difficulty);
    ...
    /**
     * Add a button listener for the given difficulty and change the display score to the difficulty.
     */
    private void addDifficultyButtonListener(Button difficultyScores, final int difficulty) {
        difficultyScores.setOnClickListener(new View.OnClickListener() {
